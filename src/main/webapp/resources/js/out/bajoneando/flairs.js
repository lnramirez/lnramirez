...
if(typeof bajoneando.flairs.t16608 !== 'undefined'){
} else {

/**
* @constructor
*/
bajoneando.flairs.t16608 = (function (owner,app,flair_rend,meta16609){
this.owner = owner;
this.app = app;
...
bajoneando.flairs.t16608.prototype.om$core$IDidMount$ = true;

bajoneando.flairs.t16608.prototype.om$core$IDidMount$did_mount$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
bajoneando.flairs.t16608.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16610){
var self__ = this;
var _16610__$1 = this;
return self__.meta16609;
});

bajoneando.flairs.t16608.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16610,meta16609__$1){
var self__ = this;
var _16610__$1 = this;
return (new bajoneando.flairs.t16608(self__.owner,self__.app,self__.flair_rend,meta16609__$1));
});

bajoneando.flairs.t16608.cljs$lang$type = true;

bajoneando.flairs.t16608.cljs$lang$ctorStr = "bajoneando.flairs/t16608";

bajoneando.flairs.t16608.cljs$lang$ctorPrWriter = (function (this__4393__auto__,writer__4394__auto__,opt__4395__auto__){
return cljs.core._write.call(null,writer__4394__auto__,"bajoneando.flairs/t16608");
});

bajoneando.flairs.__GT_t16608 = (function __GT_t16608(owner__$1,app__$1,flair_rend__$1,meta16609){
return (new bajoneando.flairs.t16608(owner__$1,app__$1,flair_rend__$1,meta16609));
});

}

return (new bajoneando.flairs.t16608(owner,app,flair_rend,cljs.core.PersistentArrayMap.EMPTY));
});
