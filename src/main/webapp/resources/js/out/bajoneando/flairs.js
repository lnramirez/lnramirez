...
if(typeof bajoneando.flairs.t18489 !== 'undefined'){
} else {

/**
* @constructor
*/
bajoneando.flairs.t18489 = (function (owner,app,flair_rend,meta18490){
this.owner = owner;
this.app = app;
...
bajoneando.flairs.t18489.prototype.om$core$IRenderState$ = true;

bajoneando.flairs.t18489.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
var github = new cljs.core.Keyword(null,"github","github",567794498).cljs$core$IFn$_invoke$arity$1(self__.app);
return React.DOM.div({"id": "githubflair"},React.DOM.a({"className": "sfLink", "href": cljs.core.get.call(null,github,"html_url")},React.DOM.div({"className": "sfTable sfGithub"},React.DOM.div({"className": "sfRow"},React.DOM.div({"className": "sfCell1"},React.DOM.img({"className": "sfProfilePic", "src": cljs.core.get.call(null,github,"avatar_url"), "width": "48px", "height": "48px"})),React.DOM.div({"className": "sfCell2"},(function (){var attrs18492 = cljs.core.get.call(null,github,"name");
return cljs.core.apply.call(null,React.DOM.div,((cljs.core.map_QMARK_.call(null,attrs18492))?sablono.interpreter.attributes.call(null,sablono.util.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["sfHandle"], null)], null),attrs18492)):{"className": "sfHandle"}),cljs.core.remove.call(null,cljs.core.nil_QMARK_,((cljs.core.map_QMARK_.call(null,attrs18492))?cljs.core.PersistentVector.EMPTY:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs18492)], null))));
...
bajoneando.flairs.t18489.prototype.om$core$IDidMount$ = true;

bajoneando.flairs.t18489.prototype.om$core$IDidMount$did_mount$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
bajoneando.flairs.t18489.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18491){
var self__ = this;
var _18491__$1 = this;
return self__.meta18490;
});

bajoneando.flairs.t18489.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18491,meta18490__$1){
var self__ = this;
var _18491__$1 = this;
return (new bajoneando.flairs.t18489(self__.owner,self__.app,self__.flair_rend,meta18490__$1));
});

bajoneando.flairs.t18489.cljs$lang$type = true;

bajoneando.flairs.t18489.cljs$lang$ctorStr = "bajoneando.flairs/t18489";

bajoneando.flairs.t18489.cljs$lang$ctorPrWriter = (function (this__4393__auto__,writer__4394__auto__,opt__4395__auto__){
return cljs.core._write.call(null,writer__4394__auto__,"bajoneando.flairs/t18489");
});

bajoneando.flairs.__GT_t18489 = (function __GT_t18489(owner__$1,app__$1,flair_rend__$1,meta18490){
return (new bajoneando.flairs.t18489(owner__$1,app__$1,flair_rend__$1,meta18490));
});

}

return (new bajoneando.flairs.t18489(owner,app,flair_rend,cljs.core.PersistentArrayMap.EMPTY));
});
