...
sablono.util.ToString = (function (){var obj28068 = {};
return obj28068;
})();
...
return (function (){var or__3806__auto__ = (sablono.util.to_str[goog.typeOf(x__4450__auto__)]);
if(or__3806__auto__){
return or__3806__auto__;
} else {
var or__3806__auto____$1 = (sablono.util.to_str["_"]);
...
sablono.util.ToURI = (function (){var obj28070 = {};
return obj28070;
})();
...
var x__4450__auto__ = (((x == null))?null:x);
return (function (){var or__3806__auto__ = (sablono.util.to_uri[goog.typeOf(x__4450__auto__)]);
if(or__3806__auto__){
return or__3806__auto__;
} else {
var or__3806__auto____$1 = (sablono.util.to_uri["_"]);
if(or__3806__auto____$1){
return or__3806__auto____$1;
} else {
...
while (G__28071__i < G__28071__a.length) {G__28071__a[G__28071__i] = arguments[G__28071__i + 0]; ++G__28071__i;}
  xs = new cljs.core.IndexedSeq(G__28071__a,0);
} 
return as_str__delegate.call(this,xs);};
as_str.cljs$lang$maxFixedArity = 0;
as_str.cljs$lang$applyTo = (function (arglist__28072){
var xs = cljs.core.seq(arglist__28072);
...
var vec__28074 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__28074,(0),null);
var words = cljs.core.nthnext.call(null,vec__28074,(1));
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__28079_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__28079_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__28079_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__28079_SHARP_)){
return p1__28079_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__28079_SHARP_], null);
...
while (G__28080__i < G__28080__a.length) {G__28080__a[G__28080__i] = arguments[G__28080__i + 0]; ++G__28080__i;}
  maps = new cljs.core.IndexedSeq(G__28080__a,0);
} 
return merge_with_class__delegate.call(this,maps);};
merge_with_class.cljs$lang$maxFixedArity = 0;
merge_with_class.cljs$lang$applyTo = (function (arglist__28081){
var maps = cljs.core.seq(arglist__28081);
...
var vec__28085 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__28085,(0),null);
var names = cljs.core.nth.call(null,vec__28085,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__28085,tag_name,names){
return (function (p1__28082_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__28082_SHARP_));
});})(matches,vec__28085,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__28085,tag_name,names){
return (function (p1__28083_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__28083_SHARP_));
});})(matches,vec__28085,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__28086){
var vec__28089 = p__28086;
var tag = cljs.core.nth.call(null,vec__28089,(0),null);
var content = cljs.core.nthnext.call(null,vec__28089,(1));
...
var vec__28090 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__28090,(0),null);
var id = cljs.core.nth.call(null,vec__28090,(1),null);
var class$ = cljs.core.nth.call(null,vec__28090,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__3806__auto__ = x__$1.hasDomain();
